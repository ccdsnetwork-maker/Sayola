...
export default function ContactPage() {
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    // Firebase/Firestore submission will be connected later.
    setSubmitted(true);
  }
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm sm:p-8">
                ...
                {submitted ? (
                  ...
                  >
                    ...
                    <button
                      type="submit"
                      className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#FF6B00] px-6 py-4 font-bold text-white transition hover:bg-[#e85f00]"
                    >
                      Send Message
                      <Send size={18} />
                    </button>
